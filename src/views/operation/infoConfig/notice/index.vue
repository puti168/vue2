      ...
      <div class="content">
        ...
        >
          <el-table-column
            ...
            label="通知标题"
          ></el-table-column>
          <el-table-column align="center" label="通知消息内容" prop="noticeContentPage">
      ...
      >
        <el-form ref="formSub" :inline="true" :model="dialogForm" label-width="140px">
          ...
          <el-form-item
            ...
            prop="noticeContent"
            :rules="[
              { required: true, message: '请输入通知消息内容', trigger: 'blur' },
