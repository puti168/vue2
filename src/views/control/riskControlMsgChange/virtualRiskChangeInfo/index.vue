  ...
  <div class="game-container report-container">
    <div class="view-container dealer-container">
          ...
          <el-form-item label="变更前风控等级:" class="tagheight">
            ...
            >
              ...
              <el-option
                ...
                :key="item.id"
                :label="item.windControlLevelName ? item.windControlLevelName : '无'"
                :value="item.id"
              ></el-option>
            </el-select>
          </el-form-item>
      ...
      <div class="content">
        ...
        >
          <el-table-column prop="objectInfo" align="center" label="虚拟币账户地址">
          ...
          >
            <template slot-scope="scope">
              <div v-if="scope.row.beforeWindControlDepict">
                <el-tooltip :content="scope.row.beforeWindControlDepict" placement="top">
                  <p>
...
export default {
  ...
  methods: {
    getSelectWindControlLevel(type) {
      this.$api.getSelectWindControlLevelId({ windControlType: 4, type }).then((res) => {
        const { code } = res
        if (code === 200) {
          type === 1
