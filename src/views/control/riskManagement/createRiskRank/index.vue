  ...
  <div class="game-container report-container">
    <div class="view-container dealer-container">
      ...
      <div class="content">
        ...
        >
          <el-table-column prop="windControlType" align="center" label="风控类型">
          ...
          <el-table-column prop="windControlLevelName" align="center" label="风控层级">
            <template slot-scope="scope">
      ...
      >
        ...
        <el-form ref="formSub" :model="dialogForm" label-width="120px" :rules="rules">
...
export default {
  ...
  methods: {
    ...
    subAddOrEdit() {
      ...
      const handleClick =
        this.title !== '编辑' ? this.$api.createRiskRankAPI : this.$api.updateRiskRankAPI
