    ...
    <div class="view-container dealer-container">
      ...
      <div class="content">
        ...
        >
          ...
          <el-table-column prop="playerName" align="center" label="调整方式">
          </el-table-column>
          <el-table-column prop="parentProxyName" align="center" label="调整类型">
          </el-table-column>
          <el-table-column prop="parentProxyName" align="center" label="调整金额 ">
          </el-table-column>
          <el-table-column prop="parentProxyName" align="center" label="申请人">
          </el-table-column>
          <el-table-column
          ...
          <el-table-column prop="parentProxyName" align="center" label="备注">
          </el-table-column>
        </el-table>
        <!-- 分页 -->
        <el-pagination
