    ...
    <div class="view-container dealer-container">
      ...
      <div class="content">
        ...
        >
          ...
          <el-table-column prop="accountType" align="center" label="客户端状态">
            <template slot-scope="scope">
              {{ typeFilter(scope.row.accountType, "accountType") }}
            </template>
          </el-table-column>
          ...
          <el-table-column prop="parentProxyName" align="center" label="提款方式">
          </el-table-column>
          <el-table-column prop="parentProxyName" align="center" label="是否为大额提款">
          </el-table-column>
          <el-table-column prop="parentProxyName" align="center" label="是否为首提">
          </el-table-column>
          <el-table-column prop="parentProxyName" align="center" label="提款金额">
          </el-table-column>
          <el-table-column
