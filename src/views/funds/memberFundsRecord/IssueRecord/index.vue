    ...
    <div class="view-container dealer-container">
      ...
      <div class="content">
        ...
        >
          ...
          <el-table-column prop="parentProxyName" align="center" label="发放类型">
          </el-table-column>
          <el-table-column prop="parentProxyName" align="center" label="发放金额">
          </el-table-column>
          ...
          <el-table-column prop="parentProxyName" align="center" label="账号类型">
          </el-table-column>
          <el-table-column prop="parentProxyName" align="center" label="会员标签">
          </el-table-column>
          <el-table-column prop="parentProxyName" align="center" label="风控层级">
          </el-table-column>

          <el-table-column prop="parentProxyName" align="center" label="账号状态">
          </el-table-column>
        </el-table>
        <!-- 分页 -->
        <el-pagination
