		...
		<div class="view-container dealer-container">
			...
			<div class="content">
				...
				>
					...
					<el-table-column prop="memberName" align="center" label="代理姓名">
						<template slot-scope="scope">
							<Copy
								v-if="!!scope.row.memberName"
								:title="scope.row.memberName"
					...
					<el-table-column prop="memberName" align="center" label="代存类型">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
					<el-table-column prop="accountType" align="center" label="状态">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
					<el-table-column prop="accountType" align="center" label="代存金额">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
