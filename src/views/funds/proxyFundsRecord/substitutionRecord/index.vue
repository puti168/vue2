			...
			<div class="content">
				...
				>
					...
					>
						<template slot-scope="scope">
							<Copy
								v-if="!!scope.row.proxyRealName"
								:title="scope.row.proxyRealName"
								:copy="copy"
							>
...
export default {
	...
	computed: {
		...
		proxyAssistDepositType() {
			return this.globalDics.proxyAssistDepositType
		}
	},
	mounted() {},
	...
	methods: {
		loadData() {
			...
			this.$api
				.getProxyFundsRecordsAssistDeposit(params)
				.then((res) => {
					if (res.code === 200) {
