		...
		<div class="view-container dealer-container">
          ...
          <el-form-item label="订单状态:" class="tagheight">
			...
			<div class="content">
          	...
          	<el-table-column prop="memberName" align="center" label="订单状态">
					</el-table-column>
					<el-table-column prop="memberName" align="center" label="日期">
					</el-table-column>
					<el-table-column prop="memberName" align="center" label="代理账号">
					...
					<el-table-column prop="memberName" align="center" label="代理类型">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
          <el-table-column prop="memberName" align="center" label="账号状态">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
					<el-table-column prop="accountType" align="center" label="风控层级">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
          <el-table-column prop="accountType" align="center" label="代理等级">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
          <el-table-column prop="accountType" align="center" label="总输赢">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
          <el-table-column prop="accountType" align="center" label="场馆费">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
          <el-table-column prop="accountType" align="center" label="活动彩金">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
           <el-table-column prop="accountType" align="center" label="返水">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
          <el-table-column prop="accountType" align="center" label="账号调整">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
          <el-table-column prop="accountType" align="center" label="补单输赢">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
          <el-table-column prop="accountType" align="center" label="净输赢">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
          <el-table-column prop="accountType" align="center" label="上月结余">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
          <el-table-column prop="accountType" align="center" label="冲正后净输赢">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
          <el-table-column prop="accountType" align="center" label="佣金比例">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
           <el-table-column prop="accountType" align="center" label="等级专享">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
           <el-table-column prop="accountType" align="center" sortable="custom" label="返佣">
						<template slot-scope="scope">
							{{ typeFilter(scope.row.accountType, 'accountType') }}
						</template>
					</el-table-column>
