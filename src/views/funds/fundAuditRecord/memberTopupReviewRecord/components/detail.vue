    ...
    <div class="main-content">
        ...
        <div class="review-flex">
          ...
          >
            ...
            <el-table-column align="center" label="风险银行卡">
              <template>
                {{ list && list.cardWindControlName ? list.cardWindControlName : "-" }}
              </template>
            </el-table-column>
            <el-table-column align="center" label="风险虚拟币">
              <template>
                {{
                  list && list.virtualWindControlName ? list.virtualWindControlName : "-"
                }}
              </template>
            </el-table-column>
      ...
      <div class="review-content">
        ...
        <div class="review-flex">
          ...
          >
            ...
            <el-table-column align="center" label="流水倍数">
              <template>
      ...
      <div class="review-content">
        ...
        <div class="review-flex">
          ...
          <div>一审时间: {{ list && list.audit1Time ? list.audit1Time : "-" }}</div>
          <div>一审备注: {{ list && list.audit1Desc ? list.audit1Desc : "-" }}</div>
        ...
        <div class="review-flex">
          ...
          <div>二审时间: {{ list && list.audit2Time ? list.audit2Time : "-" }}</div>
          <div>二审备注: {{ list && list.audit2Desc ? list.audit2Desc : "-" }}</div>
...
export default {
  ...
  methods: {
    ...
    getInfo() {
      ...
      this.$api.memberIncreaseQuotaDetailsAPI(params).then((res) => {
        this.loading = false
