			...
			<div class="view-container dealer-container">
				<div class="content">
					...
					>
						...
						<el-table-column prop="userName" align="center" label="会员账号" width="150">
							<template slot-scope="scope">
						...
						<el-table-column prop="realName" align="center" label="会员姓名" width="150">
							<template slot-scope="scope">
						...
						<el-table-column prop="orderAmount" align="center" label="提款金额" width="180">
							<template slot-scope="scope">
						...
						<el-table-column prop="createdAt" align="center" label="申请时间" min-width="220">
							<template slot-scope="scope">
