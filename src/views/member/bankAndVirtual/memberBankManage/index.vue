  ...
  <div class="game-container report-container">
    <div class="view-container dealer-container">
      ...
      <div class="content">
        ...
        >
          <el-table-column prop="cardNumber" align="center" width="200" label="银行卡号">
          ...
          <el-table-column prop="bindNum" align="center" label="绑定账号次数" width="180">
            <template slot="header" slot-scope="scope">
              <el-popover placement="top-start" title="提示" width="280" trigger="hover">
                <div v-if="!scope.row">
                  <p>绑定的用户数量，去重计算</p>
          ...
          <el-table-column prop="withdrawalSuccessNum" align="center" width="120">
            <template slot="header">
              会员提款成功次数
              <br />
              会员提款被拒次数
          ...
          <el-table-column prop="proxyWithdrawalSuccessNum" align="center" width="120">
            <template slot="header">
              代理提款成功次数
              <br />
              代理提款被拒次数
          ...
          <el-table-column prop="operation" align="center" label="操作" width="160">
            <template slot-scope="scope">
              <el-button
                ...
                size="medium"
                @click="
                  eidtDialog(scope.row.blacklistStatus === 0 ? '开启' : '禁用', scope.row)
                "
              >
