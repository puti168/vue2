      ...
      <div class="params">
        <el-form ref="form" :inline="true" :model="queryData" label-width="100px">
          ...
          <el-form-item label="账号状态">
            <el-select v-model="form.status" size="medium" placeholder="全部" clearable>
          ...
          <el-form-item label="会员类型">
            <el-select v-model="form.userType" size="medium" placeholder="全部" clearable>
              <el-option label="全部" value></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="注册终端">
            <el-select v-model="form.terminal" size="medium" placeholder="全部" clearable>
              <el-option label="全部" value></el-option>
            </el-select>
          </el-form-item>
