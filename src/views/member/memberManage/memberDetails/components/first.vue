	...
	<div id="basicInformation">
		<el-row>
			...
			<el-col :span="16" class="btngroup aaaaa">
				...
				<el-button type="primary" @click="editFn('账号备注')">
					账号备注
				</el-button>
				<el-button
		...
		<el-row class="msgList">
			...
			<el-col :span="5">
				...
				<div v-else style="display: inline-block">
					...
					<span
						...
						class="redColor"
					>
						(风控层级：{{ outlineInfoList.ipWindControlName }})
					</span>
			...
			<el-col :span="5">
				...
				<i v-if="activeL" class="el-icon-loading"></i>
				<span
					v-else-if="editMsgList[2].applyStatus === '1'"
					class="orangeColor"
				>
			...
			<el-col :span="5">
				...
				<span v-else>
					{{
						outlineInfoList.transforNum !== null
							? outlineInfoList.transforNum
							: 0
					}}次
				</span>
			</el-col>
		...
		<el-row class="msgList">
			<el-col :span="5">
				...
				<i v-if="activeL" class="el-icon-loading"></i>
				<span
					v-else-if="editMsgList[5].applyStatus === '1'"
					class="orangeColor"
				>
			...
			<el-col :span="5">
				...
				<i v-if="activeL" class="el-icon-loading"></i>
				<span
					v-else-if="editMsgList[6].applyStatus === '1'"
					class="orangeColor"
				>
			...
			<el-col :span="5">
				...
				<i v-if="activeL" class="el-icon-loading"></i>
				<span
					v-else-if="editMsgList[3].applyStatus === '1'"
					class="orangeColor"
				>
			...
			<el-col :span="5">
				...
				<i v-if="activeL" class="el-icon-loading"></i>
				<span
					v-else-if="editMsgList[4].applyStatus === '1'"
					class="orangeColor"
				>
			...
			<el-col :span="5">
				...
				<i v-if="activeL" class="el-icon-loading"></i>
				<span
					v-else-if="editMsgList[7].applyStatus === '1'"
					class="orangeColor"
				>
			...
			<el-col :span="12" class="paddingBox">
				<el-row>
					...
					<el-col :span="7" class="textR">
						...
						<span v-else>
							{{
								vipMsgList.depositAmountLave === null
									? ''
				...
				<el-row>
					...
					<el-col :span="7" class="textC">
						(保级:
						{{
							vipMsgList.bjValidBetsDate === null
								? '-'
								: vipMsgList.bjValidBetsDate
						}})有效投注
					</el-col>
				</el-row>
			</el-col>
...
export default {
	mixins: [list],
	props: {
		firstStatusShow: { type: Boolean, default: () => false },
			...
			switch (val) {
				...
				case '会员标签':
					this.editData.labelId =
						this.outlineInfoList.labelId === '0'
							? ''
