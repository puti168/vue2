<template>
  <div class="game-container report-container">
    ...
    <addDetail v-else :type="type" :rowData="rowData" @goBack="goBack"></addDetail>
  </div>
</template>
  ...
  methods: {
    loadData() {
      ...
      let params = {
        ...
        auditTimeStart: startTime2 ? dayjs(startTime2).format('YYYY-MM-DD HH:mm:ss') : '',
        auditTimeEnd: endTime2 ? dayjs(endTime2).format('YYYY-MM-DD HH:mm:ss') : ''
      }
      params = {
