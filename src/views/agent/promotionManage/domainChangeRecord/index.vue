				...
				>
					...
					<el-table-column align="center" label="变更前" prop="beforeModify">
						<template slot-scope="scope">
							<div
								v-if="
									scope.row.operateField === 3 || scope.row.operateField === 4
								"
							>
								<span
									v-if="
										scope.row.operateField === 3 &&
											scope.row.beforeModify === '0'
									"
									class="disableRgba"
								>
