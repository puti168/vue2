    ...
    <div class="content">
      ...
      <el-table :data="list" style="width: 100%" :header-cell-style="getRowClass">
        ...
        <el-table-column
          align="center"
          prop="roleName"
          :label="$t('system_component_role_390')"
        ></el-table-column>
        <el-table-column prop="status" :label="$t('system_component_role_384')">
          <template slot-scope="scope">
            ...
            <el-switch
              :disabled="!hasPermission('5332') || scope.row.roleName === 'admin'"
        ...
        <el-table-column
          align="center"
          prop="createBy"
          :label="$t('system_component_role_388')"
        ></el-table-column>
        <el-table-column
          align="center"
          fixed="right"
      ...
      >
        ...
        <span slot="footer" class="dialog-footer">
          <el-button @click="delDialogVisible = false">{{
            $t("system_component_role_402")
          }}</el-button>
          <el-button type="primary" @click="deleteRow">{{
            $t("system_component_role_403")
          }}</el-button>
        </span>
      </el-dialog>
    </div>
