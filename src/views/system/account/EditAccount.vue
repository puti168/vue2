        ...
        >
          <el-row>
            <el-col>
              ...
              <el-row>
                ...
                >
                  <el-input
                    ...
                    style="width: 300px"
                    minlength="3"
                    :placeholder="$t('system_component_component_editaccount_410')"
                  ></el-input>
                </el-form-item>
              </el-row>
              <el-row>
                <el-form-item
                  :label="$t('system_component_component_editaccount_411')"
                  prop="nickName"
                >
                  <el-input
                    ...
                    maxlength="10"
                    style="width: 300px"
                    :placeholder="$t('system_component_component_editaccount_412')"
                  ></el-input>
                </el-form-item>
              </el-row>
              ...
              <el-row>
                <el-form-item :label="$t('login_index_260')" prop="googleAuthCode">
                  <el-input
...
<script>
import { getRoles, getUserRoles, editUser, addUser } from '@/api/user'
...
export default {
  ...
  computed: {
    rules() {
      ...
      return {
        pwd: [{ required: true, validator: this.validatePass, trigger: 'blur' }],
        rePwd: [{ required: true, validator: this.validateRePass, trigger: 'blur' }],
        userName: [
          {
            required: true,
            trigger: 'change',
          ...
          if (valid) {
            ...
            handle(params).then((res) => {
              if (res.code === 200) {
                ...
                message({
                  message: this.$t('system_component_component_editaccount_422'),
                  type: 'success'
                })
