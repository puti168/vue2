  ...
  <div class="game-container">
    ...
    <div class="content">
      <el-form ref="form" :model="form" :rules="rules" label-width="auto">
        ...
        <el-form-item>
          <el-button type="primary" @click.native="handleSure">{{
            $t("btn.confirm")
          }}</el-button>
        </el-form-item>
      </el-form>
  ...
  computed: {
    rules() {
      ...
      return {
        ...
        rePwd: [{ required: true, validator: validatorPassword, trigger: 'blur' }]
      }
    }
  },
  mounted() {
    ...
    handleSure() {
      this.$refs.form.validate((valid) => {
        if (valid) {
          ...
          this.$confirm(this.$t('message.isModifyPassword'), this.$t('message.tip'), {
            ...
            .then(() => {
              this.$api.modifyPwd(params).then(
                (res) => {
                  ...
                  this.$confirm(this.$t('message.modifyPasswordSuccessfully'), '', {
                    confirmButtonText: this.$t('btn.confirm'),
                    type: 'success'
                  })
                    .then(() => {
