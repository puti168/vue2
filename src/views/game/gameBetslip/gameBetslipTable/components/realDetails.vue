			...
			<div class="betslip">
				...
				<div>
					<el-row class="paddingLR paddingB">
						...
						<el-col :span="9">
							玩法名称： {{ dataList.gameTypeName || '-' }}
						</el-col>
						<el-col :span="6">
							游戏桌台号： {{ dataList.tableCode || '-' }}
						</el-col>
						<el-col :span="9">
							投注玩法： {{ dataList.playOptionName || '-' }}
						</el-col>
						<el-col :span="9">
							玩法赔率： {{ dataList.oddsValue || '-' }}
						</el-col>
						<el-col :span="6">
							局结果： {{ dataList.judgeResult1 || '-' }}
						</el-col>
						<el-col :span="9">
							投注金额： {{ dataList.betAmount || '-' }}
						</el-col>
						<el-col :span="9">
							有效投注： {{ dataList.validBetAmount || '-' }}
						</el-col>
						<el-col :span="6">
							输赢金额： {{ dataList.netAmount || '-' }}
						</el-col>
						<el-col :span="9">
							注单归类： {{ dataList.betStatus || '-' }}
						</el-col>
